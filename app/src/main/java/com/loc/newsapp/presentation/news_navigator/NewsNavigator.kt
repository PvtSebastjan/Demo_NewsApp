...
import com.loc.newsapp.presentation.video.VideoViewModel
...
fun NewsNavigator() {
    ...
    val bottomNavigationItems = remember {
        listOf(
            ...
            BottomNavigationItem(icon = R.drawable.ic_network, text = "Videos"),
            BottomNavigationItem(icon = R.drawable.ic_preferences, text = "Login"),
        )
    }
    ...
    selectedItem = when (backStackState?.destination?.route) {
        ...
        Route.VideoScreen.route -> 3
        Route.LoginScreen.route -> 4
        else -> 0
    }
        ...
        NavHost(
            ...
            composable(route = Route.DetailsScreen.route) {
                ...
                if (viewModel.sideEffect != null) {
                    val sideEffectText =
                        viewModel.sideEffect.toString() // Converting to CharSequence
                    Toast.makeText(LocalContext.current, sideEffectText, Toast.LENGTH_SHORT).show()
